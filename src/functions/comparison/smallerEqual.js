...
// Smaller equal function class
class LimeFunctionSmallerEqual extends LimeFunction {
  // Constructor
  constructor(lime, mode) {
    // Super from function class
    super(lime, { name: 'smallerEqual', mode });
...
// Export
module.exports = LimeFunctionSmallerEqual;
